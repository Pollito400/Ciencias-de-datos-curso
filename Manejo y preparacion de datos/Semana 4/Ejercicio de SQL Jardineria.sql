...
from oficina
go
-- Segun la Ciudad y el Telefono con filtro de Pais
select ciudad, telefono 
from oficina
where pais = 'EEUU'
go

-- Devolver nombre apellidos de los empleados donde el codigo de jefe es igual a 7
select nombre, apellido1, apellido2 
from empleado
where codigo_jefe = 7
go
-- Devolver nombre apellidos y el puesto de los empleados que no sean de ventas
select nombre, apellido1, apellido2, puesto 
from empleado
where puesto != 'Represtante Ventas'
go
